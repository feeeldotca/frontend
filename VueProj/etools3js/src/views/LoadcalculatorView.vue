...
function clearInput() {
  const mixedInput = [baseArea, gradeArea, spaceHeating, acLoading, otherHeating, moreRange, tankless, firstRange, steamer, poolHeater, hotTub, SPAHeater, evSupply, evEMS, otherLoads]
  mixedInput.slice((item)=>item.value='') 
}
  ...
  <div class="container">
    ...
    <div class="box1">
      <dl>
        ...
        <div class="input1">
          <input type="text" id="input-basement" size="5" placeholder="0" class="inputnumbers"
            title="Please enter a number" v-model="baseArea" />
        </div>
      </dl>
      <dl>
        <div class="prelabel">
        ...
        <div class="input1">
          <input type="text" id="input-abovegrade" size="5" placeholder="0" class="inputnumbers"
            title="Please enter a number" v-model="gradeArea" />
        </div>
      </dl>
    </div>
    ...
    <div class="box1" v-if="acHT">
      ...
      <dl>
        ...
        <div class="input1">
          <input type="text" id="input-spaceheating" size="5" placeholder="0" class="inputnumbers"
            title="Please enter a number" v-model="spaceHeating" />
        </div>
      </dl>
      <dl>
        <div class="prelabel">
        ...
        <div class="input1">
          <input type="text" id="input-ac" size="5" placeholder="0" class="inputnumbers" title="Please enter a number"
            v-model="acLoading" />
        </div>
      </dl>
      ...
      <dl>
        ...
        <div class="input1">
          <input type="text" id="inputotherheating" size="5" placeholder="0" class="inputnumbers"
            title="Please enter a number" v-model="otherHeating" />
        </div>
      </dl>
    </div>
    ...
    <div class="box1" v-if="hasRange">
      <dl>
        ...
        <div class="input1">
          <input type="text" id="input-range" size="5" placeholder="0" class="inputnumbers"
            title="Please enter a number" v-model="firstRange" />
        </div>
      </dl>
      <dl>
        <div class="prelabel">
          <label for="input-otherrange">Other electric range loads(if any):
          </label>
        </div>
        <div class="input1">
          <input type="text" id="input-otherrange" size="5" placeholder="0" class="inputnumbers"
            title="Please enter a number" v-model="moreRange" />
        </div>
      </dl>
    </div>
    <h4 class="headings">
      <input type="checkbox" v-model="hasWTHT" id="hasWTHT" />
      <label for="hasWTHT">Electric Water Heater Loads <i>(KW)</i></label>
    </h4>
    <div class="box1" v-if="hasWTHT">
      <dl>
        ...
        <div class="input1">
          <input type="text" id="input-tankless" size="5" placeholder="0" class="inputnumbers"
            title="Please enter a number" v-model="tankless" />
        </div>
      </dl>
      <dl>
        <div class="prelabel">
        ...
        <div class="input1">
          <input type="text" id="input-steamer" size="5" placeholder="0" class="inputnumbers"
            title="Please enter a number" v-model="steamer" />
        </div>
      </dl>
      <dl>
        <div class="prelabel">
        ...
        <div class="input1">
          <input type="text" id="input-pool" size="5" placeholder="0" class="inputnumbers" title="Please enter a number"
            v-model="poolHeater" />
        </div>
      </dl>
      <dl>
        ...
        <div class="input1">
          <input type="text" id="input-hottub" size="5" placeholder="0" class="inputnumbers"
            title="Please enter a number" v-model="hotTub" />
        </div>
      </dl>
      <dl>
        <div class="prelabel">
        ...
        <div class="input1">
          <input type="text" id="input-spa" size="5" placeholder="0" class="inputnumbers" title="Please enter a number"
            v-model="SPAHeater" />
        </div>
      </dl>
    </div>
    ...
    <div class="box1" v-if="hasEV">
      <dl>
        ...
        <div class="input1">
          <input type="text" id="inputev" size="5" placeholder="0" class="inputnumbers" title="Please enter a number"
            v-model="evSupply" />
        </div>
      </dl>
      <dl>
        ...
        <div class="input1">
          <input type="text" id="inputevems" size="5" placeholder="0" class="inputnumbers" title="Please enter a number"
            v-model="evEMS" />
        </div>
      </dl>
    </div>
    ...
    <div class="box1" v-if="hasOther">
      <dl>
        <div class="prelabel">
          <label for="input-otherloads">Total of loads in excess of 1.5KW:
          </label>
        </div>
        <div class="input1">
          <input type="text" id="input-otherloads" size="5" placeholder="0" class="inputnumbers"
            title="Please enter a number" v-model="otherLoads" />
        </div>
      </dl>
    </div>
    <LoadCalculator @clear-data="clearInput"/>
  </div>
</template>

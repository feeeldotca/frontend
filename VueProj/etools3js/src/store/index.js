  ...
  getters: {
    ...
    getFeederAwg: (state) => {
      (amp, tempInsulation)=>{
        ...
        return {t2:table2.awg_size[index2], t4: table4.awg_size[index4]}

      }
    }
    //(amp) => Object.keys(tables[0]).find(a => a.copper_loads_amp > amp)
  },
  mutations: {
    updateLoads(state, loads){
